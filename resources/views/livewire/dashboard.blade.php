    ...
    <div class="container-fluid py-4 ">
        <div class="col-lg-12 mb-4">
            <div class="card h-100">
                <div class="card-header pb-4 p-4">
                    <div class="row">
                        <div class="col-6 d-flex align-items-center">
                            <h6 class="mb-0">Dafar Siswa</h6>
                        </div>
                        <div class="col-6 text-end">
                            <button class="btn btn-outline-primary btn-sm mb-0">Tampilkan Semua</button>
                        </div>
                    </div>
                </div>
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                            <div class="d-flex flex-column">
                                <h6 class="mb-1 text-dark font-weight-bold text-sm">{{ $student->name }}</h6>
                            </div>
                            <div></div>
                            <div class="d-flex align-items-center text-sm">
                                total bintang :
                                <a class="btn btn-link text-dark text-sm mb-0 px-0 ms-4" href="{{ route('score',['studentId' => $student->id]) }}">
